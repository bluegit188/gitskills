...
##############################################################################
EXEC   	  = onemin_24hr_ooF1D_ex5_2hr_v2
SRC_FILES = Main.cpp OneMin24Hr.cpp DailyRTH.cpp TimeZones.cpp Tokenizer.cpp
VPATH= /home/jgeng/junfei_lib/Base
...
# for acpub machines
#LIB_DIR     = /afs/acpub/project/cps/tapestry
